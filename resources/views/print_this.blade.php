...
<html lang="en"><head>
  ...
  <title class="noPrint">Document</title>
  <link rel="stylesheet" href="/print/print.css" type="text/css" media="print" />
</head>
<body>
  <article style="color: #828286; display: block; font-size: 18px; margin: 0 auto; max-width: 650px; text-align: center" class="email">
    ...
    <p style="margin-top: 0" class="mt0">Claudia Vilca</p>
    <p style="margin-bottom: 0" class="mb0"><strong>Mensaje</strong></p>
    <p style="margin-top: 0" class="mt0">El sábado a las 6:30 en el Bijao</p>
    <p style="margin-bottom: 0" class="mb0"><strong>Contacto</strong></p>
    <p style="margin: 0" class="m0">976567800</p>
    <p style="margin-top: 0" class="mt0">xy@gmail.com</p>
    <hr>
    <footer style="font-size: 0.9em" class="footer">
      ...
      <a href="javascript:window.print()" class="noPrint">Imprimir esta página</a>
    </footer>
  </article>
  <article style="color: #828286; display: block; font-size: 18px; margin: 0 auto; max-width: 650px; text-align: center" class="email">
    <img style="display: inline-block; margin-bottom: 2em" class="email__logo" src="http://" alt="">
